...
<div class="flex bg-transparent border rounded-lg shadow-md hover:bg-gray-900/10 border-gray-900/10">
  ...
  <img class="w-24 align-middle border-none rounded rounded-t-lg shadow" src="{{ asset($music->album->cover_image) }}"
    alt="{{ $playlist->name }}" style="width: 8rem; height: 8rem;object-fit: cover;" />
