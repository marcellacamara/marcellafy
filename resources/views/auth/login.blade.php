  ...
  <x-auth-card>
    ...
    <form method="POST" action="{{ route('login') }}">
      ...
      <div>
        ...
        <x-input id="email" class="block w-full px-1 mt-1 text-black" type="email" name="email" :value="old('email')"
          required autofocus />
      </div>
      ...
      <div class="mt-4 text-black">
        ...
        <x-input id="password" class="block w-full px-1 mt-1" type="password" name="password" required
